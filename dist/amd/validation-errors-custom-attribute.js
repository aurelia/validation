define(['exports', 'aurelia-binding', 'aurelia-dependency-injection', 'aurelia-templating', './validation-controller', './validation-renderer'], function (exports, _aureliaBinding, _aureliaDependencyInjection, _aureliaTemplating, _validationController, _validationRenderer) {
  'use strict';
