...
define("validation-error", ["require", "exports"], function (require, exports) {
    "use strict";
    /**
     * A validation error.
     */
...
define("validate-trigger", ["require", "exports"], function (require, exports) {
    "use strict";
    /**
    * Validation triggers.
    */
...
define("property-info", ["require", "exports", 'aurelia-binding'], function (require, exports, aurelia_binding_1) {
    "use strict";
...
define("validation-renderer", ["require", "exports"], function (require, exports) {
    "use strict";
});
define("validation-controller", ["require", "exports", "validator", "validate-trigger", "property-info", "validation-error"], function (require, exports, validator_1, validate_trigger_1, property_info_1, validation_error_1) {
    "use strict";
    /**
...
define("validate-binding-behavior", ["require", "exports", 'aurelia-dependency-injection', 'aurelia-task-queue', "validation-controller", "validate-trigger"], function (require, exports, aurelia_dependency_injection_1, aurelia_task_queue_1, validation_controller_1, validate_trigger_2) {
    "use strict";
    /**
    ...
    var ValidateBindingBehavior = (function () {
        ...
        */
        ...
        ValidateBindingBehavior.prototype.bind = function (binding, source, rulesOrController, rules) {
            ...
            if (controller.validateTrigger === validate_trigger_2.validateTrigger.change) {
            ...
            else if (controller.validateTrigger === validate_trigger_2.validateTrigger.blur) {
            ...
            if (controller.validateTrigger !== validate_trigger_2.validateTrigger.manual) {
...
define("validation-controller-factory", ["require", "exports", 'aurelia-dependency-injection', "validation-controller"], function (require, exports, aurelia_dependency_injection_2, validation_controller_2) {
    "use strict";
    /**
    ...
    var ValidationControllerFactory = (function () {
        ...
        ValidationControllerFactory.prototype.create = function () {
            return this.container.invoke(validation_controller_2.ValidationController);
        };
        /**
         * Creates a new controller and registers it in the current element's container so that it's
         * available to the validate binding behavior and renderers.
        ...
        ValidationControllerFactory.prototype.createForCurrentScope = function () {
            ...
            this.container.registerInstance(validation_controller_2.ValidationController, controller);
            return controller;
        };
        ValidationControllerFactory.inject = [aurelia_dependency_injection_2.Container];
        return ValidationControllerFactory;
    }());
    exports.ValidationControllerFactory = ValidationControllerFactory;
});
define("validation-errors-custom-attribute", ["require", "exports", 'aurelia-binding', 'aurelia-dependency-injection', 'aurelia-templating', "validation-controller"], function (require, exports, aurelia_binding_2, aurelia_dependency_injection_3, aurelia_templating_1, validation_controller_3) {
    "use strict";
    var ValidationErrorsCustomAttribute = (function () {
        ...
        ValidationErrorsCustomAttribute.prototype.render = function (instruction) {
            var _loop_2 = function(error) {
                var index = this_2.errors.findIndex(function (x) { return x.error === error; });
                if (index !== -1) {
                    this_2.errors.splice(index, 1);
                }
            };
            var this_2 = this;
        ...
        ValidationErrorsCustomAttribute.inject = [Element, aurelia_dependency_injection_3.Lazy.of(validation_controller_3.ValidationController)];
        ValidationErrorsCustomAttribute = __decorate([
            aurelia_templating_1.customAttribute('validation-errors', aurelia_binding_2.bindingMode.twoWay)
        ], ValidationErrorsCustomAttribute);
        return ValidationErrorsCustomAttribute;
    }());
    exports.ValidationErrorsCustomAttribute = ValidationErrorsCustomAttribute;
});
define("validation-renderer-custom-attribute", ["require", "exports", "validation-controller"], function (require, exports, validation_controller_4) {
    "use strict";
    var ValidationRendererCustomAttribute = (function () {
        ...
        ValidationRendererCustomAttribute.prototype.bind = function () {
            this.controller = this.container.get(validation_controller_4.ValidationController);
...
define("implementation/metadata-key", ["require", "exports"], function (require, exports) {
    "use strict";
    exports.metadataKey = 'validation:rules';
});
define("implementation/rule", ["require", "exports"], function (require, exports) {
    "use strict";
});
define("implementation/util", ["require", "exports"], function (require, exports) {
    "use strict";
...
define("implementation/validation-parser", ["require", "exports", 'aurelia-binding', 'aurelia-templating', "implementation/util"], function (require, exports, aurelia_binding_3, aurelia_templating_2, util_1) {
    "use strict";
    var ValidationParser = (function () {
        function ValidationParser(parser, bindinqLanguage) {
            this.parser = parser;
            this.bindinqLanguage = bindinqLanguage;
            this.emptyStringExpression = new aurelia_binding_3.LiteralString('');
            this.nullExpression = new aurelia_binding_3.LiteralPrimitive(null);
            this.undefinedExpression = new aurelia_binding_3.LiteralPrimitive(undefined);
        }
        ValidationParser.prototype.coalesce = function (part) {
            // part === null || part === undefined ? '' : part
            return new aurelia_binding_3.Conditional(new aurelia_binding_3.Binary('||', new aurelia_binding_3.Binary('===', part, this.nullExpression), new aurelia_binding_3.Binary('===', part, this.undefinedExpression)), this.emptyStringExpression, new aurelia_binding_3.CallMember(part, 'toString', []));
        };
        ValidationParser.prototype.parseMessage = function (message) {
            var parts = this.bindinqLanguage.parseInterpolation(null, message);
            if (parts === null) {
                return new aurelia_binding_3.LiteralString(message);
            }
            var expression = new aurelia_binding_3.LiteralString(parts[0]);
            for (var i = 1; i < parts.length; i += 2) {
                expression = new aurelia_binding_3.Binary('+', expression, new aurelia_binding_3.Binary('+', this.coalesce(parts[i]), new aurelia_binding_3.LiteralString(parts[i + 1])));
            }
            return expression;
        };
        ...
        ValidationParser.prototype.parseProperty = function (property) {
            ...
            if (accessor instanceof aurelia_binding_3.AccessMember && accessor.object instanceof aurelia_binding_3.AccessScope) {
                return {
                    name: accessor.name,
                    displayName: null
                };
        ...
        ValidationParser.inject = [aurelia_binding_3.Parser, aurelia_templating_2.BindingLanguage];
        return ValidationParser;
    }());
    exports.ValidationParser = ValidationParser;
});
define("implementation/validation-messages", ["require", "exports", "implementation/validation-parser"], function (require, exports, validation_parser_1) {
    "use strict";
    /**
...
define("implementation/standard-validator", ["require", "exports", 'aurelia-templating', 'aurelia-metadata', "validator", "validation-error", "implementation/metadata-key", "implementation/validation-messages"], function (require, exports, aurelia_templating_3, aurelia_metadata_1, validator_2, validation_error_2, metadata_key_1, validation_messages_1) {
    "use strict";
    /**
     * Validates.
     * Responsible for validating objects and properties.
    ...
    var StandardValidator = (function (_super) {
        ...
        StandardValidator.prototype.validate = function (object, propertyName, rules) {
            ...
            var addError = function (rule, value) {
                ...
                errors.push(new validation_error_2.ValidationError(rule, message, object, rule.property.name));
            };
            // validate each rule.
            var promises = [];
        ...
        StandardValidator.inject = [validation_messages_1.ValidationMessageProvider, aurelia_templating_3.ViewResources];
        return StandardValidator;
    }(validator_2.Validator));
    exports.StandardValidator = StandardValidator;
});
define("implementation/validation-rules", ["require", "exports", 'aurelia-metadata', "implementation/util", "implementation/metadata-key", "implementation/validation-messages"], function (require, exports, aurelia_metadata_2, util_2, metadata_key_2, validation_messages_2) {
    "use strict";
    /**
    ...
    var FluentRules = (function () {
        ...
        FluentRules.prototype.required = function () {
            return this.satisfies(function (value) {
                return value !== null
                    && value !== undefined
                    && !(util_2.isString(value) && !/\S/.test(value));
    ...
    var FluentEnsure = (function () {
        ...
        FluentEnsure.prototype.on = function (target) {
            ...
            aurelia_metadata_2.metadata.define(metadata_key_2.metadataKey, this.rules, target);
            return this;
        };
    ...
    var ValidationRules = (function () {
        ...
        ValidationRules.customRule = function (name, condition, message, argsToConfig) {
            validation_messages_2.validationMessages[name] = message;
...
// Exports
define("aurelia-validation", ["require", "exports", "validate-binding-behavior", "validate-trigger", "validation-controller", "validation-controller-factory", "validation-error", "validation-errors-custom-attribute", "validation-renderer-custom-attribute", "validator", "implementation/metadata-key", "implementation/standard-validator", "implementation/validation-messages", "implementation/validation-parser", "implementation/validation-rules", "validator", "implementation/standard-validator", "implementation/validation-parser", "implementation/validation-rules"], function (require, exports, validate_binding_behavior_1, validate_trigger_3, validation_controller_5, validation_controller_factory_1, validation_error_3, validation_errors_custom_attribute_1, validation_renderer_custom_attribute_1, validator_3, metadata_key_3, standard_validator_1, validation_messages_3, validation_parser_2, validation_rules_1, validator_4, standard_validator_2, validation_parser_3, validation_rules_2) {
    "use strict";
    function __export(m) {
        for (var p in m) if (!exports.hasOwnProperty(p)) exports[p] = m[p];
    }
    __export(validate_binding_behavior_1);
    __export(validate_trigger_3);
    __export(validation_controller_5);
    __export(validation_controller_factory_1);
    __export(validation_error_3);
    __export(validation_errors_custom_attribute_1);
    __export(validation_renderer_custom_attribute_1);
    __export(validator_3);
    __export(metadata_key_3);
    __export(standard_validator_1);
    __export(validation_messages_3);
    __export(validation_parser_2);
    __export(validation_rules_1);
    function configure(frameworkConfig, config) {
        // the fluent rule definition API needs the parser to translate messages
        // to interpolation expressions. 
        var parser = frameworkConfig.container.get(validation_parser_3.ValidationParser);
        ...
        if (!config.customValidator) {
            ...
            frameworkConfig.container.registerInstance(validator_4.Validator, validator);
        }
