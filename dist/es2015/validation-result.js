export let ValidationResult = class ValidationResult {
  constructor() {
    this.isValid = true;
    this.properties = {};
  }
...
export let ValidationResultProperty = class ValidationResultProperty {
  constructor(group) {
    this.group = group;
  ...
  setValidity(validationResponse, shouldBeDirty) {
    let notifyObservers = !this.isDirty && shouldBeDirty || this.isValid !== validationResponse.isValid || this.message !== validationResponse.message;
