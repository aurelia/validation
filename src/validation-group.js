...
export class ValidationGroup {
   ...
   */
  validate(forceDirty = true, forceExecution = true): Promise<ValidationResult> {
  ...
  onValidate(validationFunction, validationFunctionFailedCallback): ValidationGroup {
   ...
   */
  ensure(bindingPath, configCallback): ValidationGroup {
   ...
   * @returns {ValidationGroup} returns this ValidationGroup, to enable fluent API
   */
  withMessage(message: any): ValidationGroup {
